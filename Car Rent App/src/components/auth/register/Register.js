        ...
        <div className="user-form-wrapper">
            <Form onSubmit={onFormSubmit}>
                ...
                <Form.Group className="mb-3" controlId="formBasicEmail">
                    ...
                    <Form.Control type="text" placeholder="Enter name" value={user.name} name="name" onChange={onInputChange} required/>
                </Form.Group>
                ...
                <Form.Group className="mb-3" controlId="formBasicEmail">
                    ...
                    <Form.Control type="tel" placeholder="Enter phone number" value={user.phone} name="phone" onChange={onInputChange} required/>
                </Form.Group>

                <Form.Group className="mb-3" controlId="formBasicEmail">
                    <Form.Label>Address</Form.Label>
                    <Form.Control type="text" placeholder="Enter address" value={user.address} name="address" onChange={onInputChange} required/>
                </Form.Group>
